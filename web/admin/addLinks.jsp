    ...
    <script type="text/javascript">
        $(function () {
            $("#saveBtn").click(function () {
                $("#addLinksForm").ajaxForm({
                    url: 'admin/link/addLinks.do',
                    type: 'post',
                    clearForm: true,
                    success: function (data) {
                        if (data.success){
                            window.location.href="admin/addLinks.jsp";
                        }
                    },
                    error: function (data) {
                        window.warning("系统繁忙,请稍后再试!");
                    }
                })
            });
        })
    ...
    <nav id="navbar-example" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin.jsp">博客管理中心</a>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-md-10 pull-right" style="background-color:#FFFFFF;">
            ...
            <div class="container-fluid" style="min-height: 800px;">
                <div class="row">
                    <form id="addLinksForm" method="post" action="">
                        <h4>带&nbsp;<b><span class="text-danger">*</span></b>&nbsp;号的为必填项</h4>
                        <div class="form-group">
                            <label>友情链接名称：&nbsp;<b><span class="text-danger">*</span></b></label>
                            <input type="text" class="form-control" name="name" placeholder="友情链接名称" required
                                   autofocus>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="text-center">
                            <button id="saveBtn" type="submit" class="btn btn-default">添加<span class="hidden">&nbsp;<img
