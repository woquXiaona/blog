...
<head>
    ...
    <script type="text/javascript">
        ...
        //菜单列表
        function listMenu(pageNo, pageSize) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data != null) {
                        $.each(data.list, function (index, obj) {
                            ...
                            html += "<td>" + obj.name + "</td>";
                            html += "<td><a href='" + obj.url + "' target='_blank'>" + obj.url + "</a></td>";
                            ...
                            html += "<td>";
                            if (obj.status == "1") {
                                html += "<h5 class='text-success'><span class='glyphicon glyphicon-ok'></span> 显示</h5>";
                            } else {
                                html += "<h5 class='text-danger'><span class='glyphicon glyphicon-remove'></span> 隐藏</h5>";
                            }
                            html += "</td>";
                            html += "<td>";
                            html += "<a href='admin/modifymenu.jsp?id=" + obj.id + "'>编辑</a>";
                            html += "&nbsp;|&nbsp;";
        ...
        function deleteById(id) {
            if (window.confirm("您确定要将菜单项删除吗?删除后不可恢复!")) {
                $.ajax({
                    url: 'admin/menu/deleteById.do',
                    data: {
                        "id": id
                    },
                    type: 'post',
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-md-10 pull-right" style="background-color:#FFFFFF;">
            <link href="common/confirm/jquery-confirm.css" type="text/css" rel="stylesheet">
