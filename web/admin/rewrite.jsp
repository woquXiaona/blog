                ...
                success: function (data) {
                    if (data.success){
                        ...
                        if (data.post.post_status=="1"){
                            $("#simiwenzhang").prop("checked",false);
                        }else {
                            $("#simiwenzhang").prop("checked",true);
                        }
                        if (data.post.istop=="1"){
                            $("#isTop").prop("checked",true);
                        }else {
                            $("#isNotTop").prop("checked",true);
                        }
                        if (data.post.recommended=="1"){
                            $("#isRecommended").prop("checked",true);
                        }else {
                            $("#isNotRecommended").prop("checked",true);
                        }
                        if (data.post.comment_status=="1"){
                            $("#enabledComment").prop("checked",true);
                        }else {
                            $("#disabledComment").prop("checked",true);
                        }
                        $("#postId").val(data.post.id);
                        $("#title").val(data.post.post_title);
                        $("#zhengwen").text(data.post.post_content);
                        $("#keywords").val(data.post.post_keywords);
                        $("#source").val(data.post.post_source);
                        $("#excerpt").html(data.post.post_excerpt);
                        if (data.post.thumbnail!=null){
                            $("#thumbnail").attr("src",data.post.thumbnail);
                        }
                    }
                }
            })
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-md-10 pull-right" style="background-color:#FFFFFF;">
                    ...
                    <form method="post" action="" name="writeForm">
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <input id="title" type="text" autofocus class="form-control input-lg" placeholder="标题"
                                       value="" name="biaoti" required>
                            ...
                            <div class="form-group">
                                <label> 关键词：</label>
                                <input id="keywords" type="text" class="form-control input-lg" placeholder="关键词" value=""
                                       name="guanjianci">
                                <p class="help-block"> 关键词之间用逗号“,”隔开 </p>
                            </div>
                            <div class="form-group">
                                <label> 文章来源：</label>
                                <input id="source" type="text" class="form-control input-lg" placeholder="文章来源" value=""
                                       name="laiyuan">
                            </div>
                            <div class="form-group">
                                <label> 摘要：</label>
                                <textarea id="excerpt" class="form-control" rows="3" name="zhaiyao"></textarea>
                            </div>
                            <div class="form-group">
                                <label> 文章分类：</label>&nbsp;
                                [
                                <a href="admin/addclassify.jsp">添加分类</a>
                                ]
                                <select id="type" multiple class="form-control" name="fenlei[]">

                                </select>
                                <p class="help-block"> windows：按住Ctrl按钮来选择多个选项, Mac：按住command按钮来选择多个选项 </p>
                            </div>
                            <div class="form-group">
                                <label> 私密文章：</label>
                                <div class="checkbox">
                                    <label>
                                        <input id="simiwenzhang" type="checkbox" name="simiwenzhang">
                                        设置为私密文章
                                    </label>
                            ...
                            <div class="text-center">
                                <button type="button" class="btn btn-default" id="baocun"> 保存
                                    <span class="hidden"> & nbsp;
                                        <img src="common/images/zhixing.gif" width="16" height="16">
                                    </span>
                                </button>
                            </div>
                            <br><br>
                        ...
                        <div class="col-md-3">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body" id="suolvetu">
                                    <img id="thumbnail" src="common/images/default-thumbnail.png" class="img-responsive" alt="缩略图">
                                </div>
                                <div class="panel-footer">
                                    <button type="button" id="shangchuantu" class="btn btn-default btn-block" data -
                                            toggle="modal" data - target="#myModal">上传图片
                                    </button>
                                    <button type="button" id="quxiaotu" class="btn btn-default btn-block hidden">取消图片
                                    </button>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="radio">
                                        <label><input id="isTop" type="radio" name="zhiding" value="1"> 置顶 </label>
                                    </div>
                                    <div class="radio">
                                        <label><input id="isNotTop" type="radio" name="zhiding" value="0"> 不置顶 </label>
                                    </div>
                                    <hr>
                                    <div class="radio">
                                        <label><input id="isRecommended" type="radio" name="tuijian" value="1"> 推荐 </label>
                                    </div>
                                    <div class="radio">
                                        <label><input id="isNotRecommended" type="radio" name="tuijian" value="0"> 不推荐 </label>
                                    </div>
                                    <hr>
                                    <div class="radio">
                                        <label><input id="enabledComment" type="radio" name="pinglun" value="1"> 允许评论 </label>
                                    </div>
                                    <div class="radio">
                                        <label><input id="disabledComment" type="radio" name="pinglun" value="0"> 不允许评论 </label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" id="xuanbendi" class="active">
                                    <a href="#bendi" role="tab" data - toggle="tab"> 本地图片 </a>
                                </li>
                                <li role="presentation" id="xuanwangluo">
                                    <a href="#wangluo" role="tab" data - toggle="tab"> 网络图片 </a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="bendi">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <br><label> 请选择上传图片 </label>
                                            <div id="upload"></div>
                                        </div>
                                    </div>
                                    <div class="panel panel-default">
                                        <div class="panel-body" style="min-height: 199px;"></div>
                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane" id="wangluo">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body" style="min-height: 200px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <script type="text/javascript" charset="utf-8" src="common/kindeditor/kindeditor-all.js"></script>
