        ...
        <div class="col-xs-12 col-sm-9 col-md-10 pull-right" style="background-color:#FFFFFF;">
            ...
            <div class="container-fluid" style="min-height: 800px;">
                <div>
                    <p>
                        <label>批量操作：</label>
                        <button type="button" id="shenhe" class="btn btn-primary btn-sm">审核<span
                                class="hidden">&nbsp;<img
                                src="common/images/zhixing_bai.gif" width="14" height="14"></span>
                        </button>
                        <button type="button" id="weishenhe" class="btn btn-primary btn-sm">取消审核<span class="hidden">&nbsp;<img
                                src="common/images/zhixing_bai.gif" width="14" height="14"></span>
                        </button>
                    </p>
                </div>
            ...
            <div class="hidden" id="bukehuifu">您确定要删除评论吗?删除后不可恢复!</div>
