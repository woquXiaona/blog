        ...
        $(function () {
            $("#addClassifyBtn").on('click', function () {
                var options = {
                    ...
                    dataType: "json",
                    clearForm: true,
                    url: "post/category/addClassify.do",
                    success: function (data) {
                        /*if (data.success) {
                            //window.location.href = "admin/addclassify.jsp";
                        } else {
                            alert("添加失败!")
                        }*/
                    },
                ...
                $("#addClassifyForm").ajaxForm(options);
            });
        })
    </script>
</head>
    ...
    <nav id="navbar-example" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin/inedx.jsp">博客管理中心</a>
            </div>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-md-10 pull-right" style="background-color:#FFFFFF;">
            ...
            <br>
            <form id="addClassifyForm" name="addClassifyForm">
                <h4>带&nbsp;<b><span class="text-danger">*</span></b>&nbsp;号的为必填项</h4>
                <div class="form-group">
                    <label>中文名称：&nbsp;<b><span class="text-danger">*</span></b></label>
                    <input type="text" class="form-control" name="name" placeholder="分类中文名称" required
                           autofocus>
                </div>
                <div class="form-group">
                    <label>英文名称:&nbsp;<b><span class="text-danger">*</span></b></label>
                    <input type="text" class="form-control" name="url" placeholder="分类英文名称" required/>
                </div>
                <hr>
                <div class="text-center">
                    <button id="addClassifyBtn" type="submit" class="btn btn-default">添加分类<span
                            class="hidden">&nbsp;<img
                            src="common/images/zhixing.gif" width="16" height="16"></span>
                    </button>
                </div>
                <div class="container-fluid" style="min-height: 800px;"></div>
            </form>
            <div class="row">
            </div>
        </div>
