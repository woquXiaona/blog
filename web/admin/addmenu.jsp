    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#addMenuBtn").on('click', function () {
                $("#addMenuForm").ajaxForm({
                    url: 'admin/menu/addMenu.do',
                    type: 'post',
                    success: function (data) {
                        if (data.success) {
                            window.location.href = "admin/addmenu.jsp";
                        } else {
                            alert("添加失败!");
                        }
                    },
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-md-10 pull-right" style="background-color:#FFFFFF;">
            ...
            <div class="container-fluid" style="min-height: 800px;">
                <div class="row">
                    <form id="addMenuForm" method="post" action="">
                        ...
                        <div class="form-group">
                            ...
                            <select id="categoryList" class="form-control" name="url">
                                <option value="index.jsp">首页</option>
                            </select>
                            <p class="help-block">自定义链接：</p>
                            <input type="text" class="form-control" name="diyUrl" placeholder="http://">
                        </div>
                        <div class="form-group">
                            <label>打开方式：</label>
                            <select class="form-control" name="target">
                                <option value="_self">在原窗口打开</option>
                                <option value="_blank">作为新窗口打开</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>状态：</label>
                        ...
                        <div class="text-center"><br>
                            <button type="submit" class="btn btn-default" id="addMenuBtn">添加菜单<span
                                    class="hidden">&nbsp;<img
