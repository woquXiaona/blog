...
$(document).ready(function(){
    ...
    $(".jiangquan").click(function(){
        var obj = $(this);
        obj.children("span").removeClass("hidden");
        $.post("jiangquan", { id: obj.parent().siblings(":first").text()},
            function(data){
                obj.parent().siblings(":eq(5)").text(data);
                obj.children("span").addClass("hidden");
                obj.addClass("hidden").next().removeClass("hidden");
            });
    });
    $(".tiquan").click(function(){
        var obj = $(this);
        obj.children("span").removeClass("hidden");
        $.post("tiquan", { id: obj.parent().siblings(":first").text()},
            function(data){
                obj.parent().siblings(":eq(5)").text(data);
                obj.children("span").addClass("hidden");
                obj.addClass("hidden").prev().removeClass("hidden");
