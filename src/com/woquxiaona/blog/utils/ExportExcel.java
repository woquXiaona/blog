	...
	public void exportExcel(String title, String[] headers, Collection<T> dataset, OutputStream out) {
		...
		while (it.hasNext()) {
			...
			for (short i = 0; i < fields.length; i++) {
				...
				String getMethodName = "get" + fieldName.substring(0, 1).toUpperCase() + fieldName.substring(1); // getId
				try {
					Class tCls = t.getClass();
					Method getMethod = tCls.getMethod(getMethodName, new Class[] {});
					String textValue = getMethod.invoke(t, new Object[] {}).toString(); // 10000001
